package com.ruffian.android.framework.http.upload;
...
public class UploadRequestBody extends RequestBody {
    ...
    public UploadRequestBody(RequestBody requestBody, File file, int current, int totalFile, UploadResult uploadResult) {
        this.file = file;
                ...
                if (uploadResult != null) {
                    RHttp.Configure.get().getHandler().post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            uploadResult.progress(file, writtenBytesCount, totalBytesCount, progress, current, totalFile);
                        }
                    });
                }
            }
