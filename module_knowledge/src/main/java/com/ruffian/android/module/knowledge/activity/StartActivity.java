package com.ruffian.android.module.knowledge.activity;
...
import com.ruffian.android.module.knowledge.fragment.ModuleKnowledgeFragment;
...
public class StartActivity extends BaseActivity {
    ...
    private ModuleKnowledgeFragment fragment;
    ...
    private void showFragment() {
        ...
        if (fragment == null) {
            fragment = RouterUtils.build(RouterConfig.path_fmt_knowledge);
